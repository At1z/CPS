...
xlabel('Czas [s]');
ylabel('Amplituda');
title('Część sygnału cyfrowego złożona z dwóch harmonicznych (oryginalny)');
subplot(2,1,2);
plot(t, filtered_signal);
axis([0.01 0.05 -1 1])
xlabel('Czas [s]');
ylabel('Amplituda');
title('Część sygnału cyfrowego po filtracji ( własny filtr )');
...
xlabel('Czas [s]');
ylabel('Amplituda');
title('Część sygnału cyfrowego po filtracji');
